...
puts ShopsStylesPageobject.addStyletoShop.present?
ShopsStylesPageobject.addStyletoShop.click
sleep 8
assert_equal(ShopsStylesPageobject.checkStylesShopTable($test_data['style_id']).to_s,"yes","Style_id was missing in the table")
assert_equal(ShopsStylesPageobject.checkStylesShopTable($test_data['style_id'][0]).to_s,"yes","Style_id was missing in the table")
ShopsStylesPageobject.deleteStyleId($test_data['style_id'][0]).click
sleep 3
ShopsStylesPageobject.removeStyleButton.click
sleep 5
assert_equal(ShopsStylesPageobject.successfulMessage($test_data['successfulStyleDeletion'].to_s).visible?.to_s,"true", "The style wasnt deleted from the Shop")
